...
Dataset.firstPath = '/home/lart/下载/CPD/';
Dataset.datasetName = 'Pascal-S';
...
Dataset.GTdir = ['/home/lart/Datasets/RGBSaliency/',Dataset.datasetName,'/Mask-845/'];
...
[alg_params, runNum, path, cancel]...
                                = select_Alg(Dataset.firstPath, set_format);
if cancel == 1
